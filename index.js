...
app.get("/players", (req, res, next) => {
    const players = [
        ...
        },
        {
            ...
            lastName: "James",
            team: "CLE",
            photo: "https://phantom-marca.unidadeditorial.es/ce0fa6ed4b08f63546dd1f8cfa910a18/resize/1320/f/jpg/assets/multimedia/imagenes/2022/02/17/16451255007747.jpg",
            average: [
                { year: 2013, points: 78 },
                { year: 2014, points: 82 },
                { year: 2015, points: 76 },
...
app.get("/teams", (req, res, next) => res.render("teams", { layout: false }));
